...
from read_statistics.utils import get_seven_days_read_date, get_today_hot_date, get_yesterday_hot_date
...
def login(request):
    ...
    if user is not None:
        ...
        return render(requset, 'error.html', {'message':'用户名或者密码不正确'})
